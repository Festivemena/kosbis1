...
const style = {
    wrapper: `w-min flex justify justify-between items-center rounded-[100px] p-4 cursor-pointer hover:bg-[#333c45] transition-all hover:duration-200 hover:ease-in-out`,
